        ...
        <table>
          <tbody>
            <tr>
              ...
              <StandardItem name="Boomerang" levelIcons={["boomerang-blue gray", "boomerang-blue", "boomerang-red"]} index="1" data={this.state.data}/>
              <StandardItem name="Hookshot" levelIcons={["hookshot gray", "hookshot"]} index="2" data={this.state.data}/>
              <MinCountItem name="Bombs" levelIcons={["bombs gray", "bombs"]} index="3" data={this.state.data}/>
              <StandardItem name="Fire Rod" levelIcons={["fire-rod gray", "fire-rod"]} index="5" data={this.state.data}/>
              <StandardItem name="Ice Rod" levelIcons={["ice-rod gray", "ice-rod"]} index="6" data={this.state.data}/>
              <StandardItem name="Lamp" levelIcons={["lamp gray", "lamp"]} index="10" data={this.state.data}/>
              <StandardItem name="Hammer" levelIcons={["hammer gray", "hammer"]} index="11" data={this.state.data}/>
            </tr>
            <tr>
              <StandardItem name="Sword" levelIcons={["fighter-sword gray", "fighter-sword", "master-sword", "tempered-sword", "butter-sword"]} index="25" data={this.state.data}/>
              <StandardItem name="Book of Mudora" levelIcons={["book gray", "book"]} index="14" data={this.state.data}/>
              <StandardItem name="Bug Net" levelIcons={["bug-net gray", "bug-net"]} index="13" data={this.state.data}/>
              <StandardItem name="Cane of Somaria" levelIcons={["somaria gray", "somaria"]} index="15" data={this.state.data}/>
              <StandardItem name="Cane of Byrna" levelIcons={["byrna gray", "byrna"]} index="16" data={this.state.data}/>
              <StandardItem name="Cape" levelIcons={["cape gray", "cape"]} index="18" data={this.state.data}/>
            ...
            <tr>
              <StandardItem name="Boots" levelIcons={["boots gray", "boots", "boots"]} index="21" data={this.state.data}/>
              <StandardItem name="Mail" levelIcons={["green-tunic", "blue-tunic", "red-tunic"]} index="27" data={this.state.data}/>
              <StandardItem name="Flippers" levelIcons={["flippers gray", "flippers"]} index="22" data={this.state.data}/>
              <StandardItem name="Glove" levelIcons={["power-glove gray", "power-glove", "titans-mitts"]} index="20" data={this.state.data}/>
              <StandardItem name="Moon Pearl" levelIcons={["moon-pearl gray", "moon-pearl"]} index="23" data={this.state.data}/>
              <StandardItem name="Bombos" levelIcons={["bombos gray", "bombos"]} index="7" data={this.state.data}/>
              <StandardItem name="Ether" levelIcons={["ether gray", "ether"]} index="8" data={this.state.data}/>
              <StandardItem name="Quake" levelIcons={["quake gray", "quake"]} index="9" data={this.state.data}/>
            </tr>
            <tr>
              ...
              <StandardItem name="Flute" levelIcons={["flute gray", "flute gray", "flute"]} index="12" data={this.state.data}/>
